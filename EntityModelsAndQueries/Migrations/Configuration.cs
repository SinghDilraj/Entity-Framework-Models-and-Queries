        ...
        protected override void Seed(EntityModelsAndQueries.Models.ApplicationDbContext context)
        {
            ...
            if (!context.Types.Any())
            {
                context.Types.AddOrUpdate(type => type.Id,
                    new Models.Domain.Type() { Name = "Single", Description = "A room assigned to one person. May have one or more beds." },
                    new Models.Domain.Type() { Name = "Double", Description = "A room assigned to two people. May have one or more beds." },
                    new Models.Domain.Type() { Name = "Queen", Description = "A room with a queen-sized bed. May be occupied by one or more people." },
                    new Models.Domain.Type() { Name = "King", Description = "A room with a king-sized bed. May be occupied by one or more people." },
                    new Models.Domain.Type() { Name = "Master Suite", Description = "A parlour or living room connected to one or more bedrooms." }
                    );
            }
